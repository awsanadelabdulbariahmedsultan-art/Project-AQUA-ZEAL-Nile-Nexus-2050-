...
```mermaid
graph TD
    A[Securing Jonglei Canal & the Final 100 km Path] --> B[Legal & Diplomatic Axis]
    A --> C[Military Field Deployment Axis]
    A --> D[Localized Socio-Developmental Axis]
    B --> B1[Mutual Defense Pact & Strategic Water Corridor Classification]
    C --> C1[Joint Egyptian & South Sudanese Special Forces & Engineers]
    D --> D1[10 Compact Water Plants + 10 Bridges + 5 Schools & Clinics]
...
```mermaid
graph TD
    A[تأمين قناة جونقلي والـ 100 كم المتبقية] --> B[المحور القانوني والسياسي]
    A --> C[المحور العسكري الميداني]
    A --> D[المحور التنموي الاجتماعي]
    B --> B1[اتفاقية دفاع مشترك واعتبار القناة منطقة استراتيجية]
    C --> C1[قوات صاعقة وتأمين هندسي مصري - سوداني مشترك]
    D --> D1[10 محطات مياه + 10 جسور ماشية + 5 مدارس ومستشفيات]
    style D1 fill:#2ecc71,color:#fff
```
