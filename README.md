...
```mermaid
graph TD
    A[Total Initial Social CAPEX: \$45 Million] --> B(Ministry of Foreign Affairs Grant: \$15 Million)
    A --> C(Central Bank of Egypt Emergency Bridge Loan: \$30 Million)
    B --> D[Builds 5 Schools & 5 Clinics]
    C --> E[Builds 10 Compact Water Plants & 10 Bridges]
    F[Weed Biorefinery Net Profits: \$16.2M/year] -->|Cross-Subsidization Flow| C
    style F fill:#2ecc71,stroke:#27ae60,stroke-width:2px,color:#fff
    style C fill:#3498db,stroke:#2980b9,stroke-width:2px,color:#fff
    note[Loan Fully Repaid In Exactly 1.8 Years]
```
...
* **الكيان الاعتباري:** أوسان دو لخدمات التسويق (AWSAN DEW FOR MARKETING SERVICES)
...
```mermaid
graph TD
    A[إجمالي الميزانية الاجتماعية المستهدفة: 45 مليون دولار] --> B(منحة وزارة الخارجية المصرية: 15 مليون دولار)
    A --> C(اعتماد مالي جسري طارئ من البنك المركزي: 30 مليون دولار)
    B --> D[بناء 5 مدارس و5 مستشفيات]
    C --> E[إنشاء 10 محطات مياه و10 جسور ماشية]
    F[صافي أرباح مشروع الحشائش السنوية: 16.2 مليون دولار] -->|تدفق السداد والمقاصة المالية| C
    style F fill:#2ecc71,stroke:#27ae60,stroke-width:2px,color:#fff
    style C fill:#3498db,stroke:#2980b9,stroke-width:2px,color:#fff
    note[يتم سداد كامل مديونية البنك المركزي خلال سنة و10 أشهر فقط]
```
...
* **المرحلة الثالثة (التصدير الكيميائي الحيوي):** توسيع مصانع جوبا وملكال لتشمل خطوط إنتاج متطورة لاستخراج البلاستيك الحيوي (Bioplastics) والمركبات العضوية pharmaceutical-grade organic compounds and bio-plastics عالية النقاء من الحشائش النهرية لتصديرها للأسواق الأوروبية كمنتجات خضراء صديقة للبيئة.
